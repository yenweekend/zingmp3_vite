...
import { SongList, Loading } from "../../components";
const Songs = () => {
  ...
  return (
    <WrappedSongs className="">
      ...
      <div>
        ...
        {data.data.data[`songs`].map((song) => (
          <div
            className="flex-auto flex items-center cursor-pointer song-info group rounded p-[10px] song-list relative"
            key={song.encodeId}
          >
